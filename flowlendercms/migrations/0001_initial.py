# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-03-15 20:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about_image', models.ImageField(blank=True, upload_to='flowlenders')),
            ],
        ),
        migrations.CreateModel(
            name='Apply',
            fields=[
                ...
                ('deatil', models.TextField(default='No', max_length=500)),
                ('pdf_image', models.ImageField(blank=True, upload_to='flowlenders')),
                ('pdf_file', models.FileField(blank=True, upload_to='flowlenders')),
            ],
        ),
        migrations.CreateModel(
            name='ClientDetail',
