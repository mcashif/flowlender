...
// Set width for inputs in horizontal search bar -----------------------------------------------------------------------
    ...
    $( "#redefine-search-form" ).load( "/static/assets/external/_search-bar.html", function() {
        setInputsWidth();
        //autoComplete();
    });
...
function autoComplete(){
    if( !$("script[src='/static/assets/js/leaflet.js']").length ){
...
function drawOwlCarousel(_rtl){
    $.getScript( "/static/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
...
function quickView(id){
    $.ajax({
        type: 'POST',
        url: '/static/assets/external/_modal.html',
        data: id,
